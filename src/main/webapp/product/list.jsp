...
<c:if test="${requestScope['message']=='removeSuccess'}"><span style="color: green">Success</span><br></c:if>
<c:if test="${requestScope['message']=='removeFail'}"><span style="color: red">Error!</span><br></c:if>

<table class="table">
    <tr>
        <th scope="col" style="background-color: grey">Product List</th>
    </tr>
    <tr>
        <table class="table " style="background-color: burlywood;border: 5px solid black">
            ...
            <div class="col" style="float: left"><a class="btn btn-primary" href="/products?action=add">Add Product</a></div>
        </table>
    </tr>
</table>
</body>
