...
<body>
<h1 style="color: blue;font-size: 40px">Edit Product</h1>
<c:if test="${requestScope['message']=='editSuccess'}"><span style="color: green">Success!</span><br></c:if>
<c:if test="${requestScope['message']=='editFail'}"><span style="color: red">Error!</span><br></c:if>
